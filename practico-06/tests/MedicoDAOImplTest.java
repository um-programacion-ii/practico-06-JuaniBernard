...
public class MedicoDAOImplTest {
    ...
    void agregarMedico() {
        ...
        Medico medico = new Medico("Juan Perez", 12345678, especialidad, true);
    ...
    void listarMedicos() {
        ...
        Medico medico1 = new Medico("Juan Perez", 12345678, especialidad1, true);
        Medico medico2 = new Medico("Ana García", 87654321, especialidad2, false);
